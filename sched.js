...
const I18N = {
  ...
  review_sub:["Go technician by technician: read the weekly report, review the work, make sure next week is assigned. Nothing gets forgotten — the list stays red until everyone is done.","Técnico por técnico: lee el reporte semanal, revisa el trabajo y asegúrate de asignar la próxima semana. Nada se olvida: la lista sigue en rojo hasta terminar con todos."],
  review_progress:["Weekly review: %1 of %2 technicians complete","Revisión semanal: %1 de %2 técnicos completados"],
  // reports moved to Thursday (Karmel 9/20) — these two are defined but not
  // rendered anywhere today; corrected so they cannot reintroduce the old wording
  fr_all:["WEEKLY REPORTS — all %1 in 🎉","REPORTES SEMANALES — los %1 entregados 🎉"],
  fr_some:["WEEKLY REPORTS — %1 of %2 in","REPORTES SEMANALES — %1 de %2 entregados"],
  ...
  planner_wait:["The plan fills in as the weekly reports arrive (due Thursday 6 PM); technicians without a report this week fall back to last week's.","El plan se llena conforme llegan los reportes semanales (se entregan el jueves a las 6 PM); los técnicos sin reporte esta semana usan el de la semana pasada."],
